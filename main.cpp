...
int main() {
  ...
  do {
    ...
    case 7:
      ...
      salvarTrajetosEmPlanilha(trajetos, "trajetos.csv");
      salvarViagensEmPlanilha(viagens, "viagens.csv");
      break;
    case 8:
      carregarDados(cidades, passageiros, transportes, trajetos, viagens,
                    "cidades.csv", "passageiros.csv", "transportes.csv",
                    "trajetos.csv", "viagens.csv");
